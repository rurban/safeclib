...
int test_wcscmp_s(void) {
    ...
    rc = wcscmp_s(NULL, LEN, str2, LEN, &ind);
    ERR(ESNULLP)
    INDZERO()

    EXPECT_BOS("empty src")
    rc = wcscmp_s(str1, LEN, NULL, LEN, &ind);
    ERR(ESNULLP)
    INDZERO()
    ...
    rc = wcscmp_s(str1, 0, str2, LEN, &ind);
    ERR(ESZEROL)
    INDZERO()

    EXPECT_BOS("empty src or smax")
    rc = wcscmp_s(str1, LEN, str2, 0, &ind);
    ERR(ESZEROL)
    INDZERO()
    ...
    rc = wcscmp_s(str1, LEN, str2, LEN, &ind);
    ERR(EOK)
    INDZERO()
    ...
    rc = wcscmp_s(str1, 5, str2, LEN, &ind);
    ERR(EOK)
    INDZERO()
    ...
    rc = wcscmp_s(str1, LEN, str1, LEN, &ind);
    ERR(EOK)
    INDZERO()
...
int main(void) { return (test_wcscmp_s()); }
